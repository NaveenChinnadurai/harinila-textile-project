...
function Footer() {
    return (
        <div className='row col-10 mx-auto d-flex justify-content-between px-5 pt-5 pb-1 rounded-bottom rounded-5 footer-bg'>
            <div className='d-flex justify-content-between'>
                ...
                <ul className="col-2 d-flex flex-column justify-content-center">
                    ...
                    <li className='fs-6 lead fw-normal'>Product <Arrow/></li>
            ...
            <p className="lead fs-6 fw-normal mt-3 d-flex align-items-center justify-content-center"><Copyrights className='fw-bold fs-5'/>2024 All rights are Reserved by Harinila Textiles</p>
        </div>
    )
}
