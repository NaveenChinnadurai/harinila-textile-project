...
/*import mainBanner from "src/assets/productImages/cotton/cottonBanner.png" 
import banner1 from "src/assets/productImages/cotton/img1.png"
import banner2 from "src/assets/productImages/cotton/img2.png"
import banner3 from "src/assets/productImages/cotton/img3.png"

import img1 from "src/assets/productImages/cotton/stock/img1.png"
import img2 from "src/assets/productImages/cotton/stock/img2.png"
import img3 from "src/assets/productImages/cotton/stock/img3.png"
import img4 from "src/assets/productImages/cotton/stock/img4.png"
import img5 from "src/assets/productImages/cotton/stock/img5.png"
import img6 from "src/assets/productImages/cotton/stock/img6.png"*/

const data = {
  headerTitle1: "Cotton Yarn",
  headerTitle2: "Harinila Textiles - Cotton Yarn Spinning",
  bannerImg: "src/assets/productImages/cotton/cottonBanner.png",
  ...
  bannerImages: [
    "src/assets/productImages/cotton/img1.png",
    "src/assets/productImages/cotton/img2.png",
    "src/assets/productImages/cotton/img3.png"
  ],
  para1: "We are a leading supplier of premium quality cotton yarn for the global market. With our commitment to excellence and customer satisfaction, we have established ourselves as a trusted partner in the textile industry. Whether you are a garment manufacturer, a wholesaler, or a textile company, we have the right cotton yarn to meet your needs.",
  para2: "Our extensive range of cotton yarns is meticulously crafted to meet the highest industry standards, ensuring superior quality and performance in every strand. From fine counts for delicate fabrics to robust options for durable textiles, we offer versatile solutions tailored to your specific requirements. Partner with us and experience the difference that premium quality cotton yarn can make in your products.",
  feature: [
    {
      title: "High-Quality Cotton Yarn",
      path: "src/assets/productImages/cotton/stock/img1.png",
    ...
    },
    {
      ...
      path: "src/assets/productImages/cotton/stock/img2.png",
    ...
    },
    {
      ...
      path: "src/assets/productImages/cotton/stock/img3.png",
    ...
    },
    {
      ...
      path: "src/assets/productImages/cotton/stock/img4.png",
    ...
    },
    {
      ...
      path: "src/assets/productImages/cotton/stock/img5.png",
    ...
    {
      title: "Global Reach",
      path: "src/assets/productImages/cotton/stock/img6.png",
