...
const data = {
    ...
    bannerImg: "../assets/productImages/knittedFabrics/knittedFabric.png",
    bannerText: "Future of Textiles industry begin Here Welcome to Knitted Fabric Division Comfort",
    bannerImages: [
        "../assets/productImages/knittedFabrics/img1.png",
        "../assets/productImages/knittedFabrics/img2.png",
        "../assets/productImages/knittedFabrics/img3.png"
    ],
