...
/* import mainBanner from "src/assets/productImages/knittedFabrics/knittedFabric.png"
import banner1 from "src/assets/productImages/knittedFabrics/img1.png"
import banner2 from "src/assets/productImages/knittedFabrics/img2.png"
import banner3 from "src/assets/productImages/knittedFabrics/img3.png"
...
const data = {
    ...
    bannerImg: "src/assets/productImages/knittedFabrics/knittedFabric.png",
    bannerText: "Future of Textiles industry begin Here Welcome to Knitted Fabric Division Comfort",
    bannerImages: [
        "src/assets/productImages/knittedFabrics/img1.png",
        "src/assets/productImages/knittedFabrics/img2.png",
        "src/assets/productImages/knittedFabrics/img3.png"
    ],
